...
const AddPurchase = Loadable(lazy(() => import('src/components/Purchase/AddPurchase')));
const ListPurchase = Loadable(lazy(() => import('src/components/Purchase/ListPurchase')));

// for report
const GrossProfitReport = Loadable(
  lazy(() => import('src/components/Reports/Profitability/GrossProfitSummary')),
);
const InventoryValuationReport = Loadable(
  lazy(() => import('src/components/Reports/Inventory/InventorySummary')),
);
...
const ListCompoundUnit = Loadable(
  lazy(() => import('src/components/CompoundUnit/ListCompoundUnit')),
);
...
const Router = [
  {
    path: '/',
    element: <ProtectedRoute />, // First, check if logged in
    children: [
      {
        element: <FullLayout />,
        children: [
          ...
          // for Purchase Invoice
          { path: '/purchase-invoice/new', exact: true, element: <AddPurchase /> },
          { path: '/purchase-invoice', exact: true, element: <ListPurchase /> },
          { path: '/purchase-invoice/edit/:id', exact: true, element: <AddPurchase /> },
